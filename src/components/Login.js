   ...
   if(!validateInput(formData))return;
    ...
    try{
      ...
      if (err.response && err.response.status === 400) {
        ...
        enqueueSnackbar("Something went wrong. Check that the backend is running, reachable an returns valid JSON", {
          variant: "error",
        });
      }
    }
    ...
    >
      ...
      <Box className="content">
        ...
        <h2 className="title">Login</h2>
          ...
          />
          <Button variant="contained" onClick={login}>Login to Qkart</Button>
